...
const Service = () => {
    return(
        <div className="body_wrapper">
            ...
            <Breadcrumb breadcrumbClass="breadcrumb_area" imgName="breadcrumb/banner_bg.png" Ptitle="Our Courses" Pdescription="Learn from a wide range of offerings taught by qualified members of the Codefy team."/>
