        ...
        <section className="support_subscribe_area sec_pad">
            ...
            <div className="container">
                <div className="sec_title text-center mb_50 wow fadeInUp" data-wow-delay="0.3s">
                    <h2 className="f_p f_size_30 l_height50 f_600 t_color3">Sign Up for Our Newsletter</h2>
                    <p className="f_400 f_size_16 mb-0">Instant Sign Up. Cancel Anytime. 100% Free.</p>
                </div>
